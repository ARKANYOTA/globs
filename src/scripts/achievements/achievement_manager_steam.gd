...
func grant(achievement_name: String) -> bool:
	...
	return GameManager.google_play_interface.grant_achievement(achievement_name)
...
func revoke(achievement_name:	String) -> bool:
	...
	return GameManager.google_play_interface.revoke_achievement(achievement_name)